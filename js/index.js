...
function displayCategory(categories) {
    ...
    categories.forEach(category => {
        ...
        <button id="act-btn" onclick='loadApiID("${category.category_id}")' class="tab focus:bg-red-600 focus:text-white bg-slate-200 rounded text-lg font-semibold text-slate-500 mx-auto ">${category.category}</button>
        `
